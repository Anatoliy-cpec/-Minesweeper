...
class Board():
    ...
    def __init__(self, field: 'Field'):
        ...
        self.frame = Frame(self.root, bg='black', bd=5, width=round(self.screen_width/2), height=round(self.screen_height/2))
    ...
    def create_board(self):
        ...
        button1=Button(self.upper_frame,text='restart', width=10,height=2, bg='black', fg='gray', font='arial 16', command=self.game.restart_game)
...
f1 = Field(field_size=25, mines=150)
